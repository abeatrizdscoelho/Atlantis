...
Este projeto foi desenvolvido como parte da disciplina **Técnicas de Programação II** do curso de **Desenvolvimento de Software Multiplataforma**, com o objetivo de construir um **Sistema em TypeScript** para gerenciamento de Clientes e seus Dependentes, aplicando o padrão de projeto **Prototype**.
