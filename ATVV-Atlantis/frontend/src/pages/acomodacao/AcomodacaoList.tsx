...
export default function Acomodacoes() {
    ...
    useEffect(() => {
        (async () => {
            const data = await listarAcomodacoes()
            setAcomodacoes(data)
        })()
    }, [])
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {acomodacoes.map((acomodacao) => (
                            <div key={acomodacao.id} className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 p-6 flex flex-col justify-between">
                                ...
                                <div className="pt-4 border-t border-gray-100">
                                    <a href={`/acomodacoes/${acomodacao.id}`}
