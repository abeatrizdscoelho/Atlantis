...
import HospedagemUpdate from './pages/hospedagem/HospedagemUpdate'
    ...
    <BrowserRouter>
      <div>
        <Routes>
          ...
          <Route path='/cliente/delete/:id' element={<ClienteRead />} />
          ...
          <Route path='/hospedagens/edit/:id' element={<HospedagemUpdate />} />
        </Routes>
      </div>
