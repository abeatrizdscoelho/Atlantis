...
Este projeto foi desenvolvido como parte da atividade **ATVV** da disciplina **Técnicas de Programação II** do curso de **Desenvolvimento de Software Multiplataforma**. 
...
```bash
git clone https://github.com/abeatrizdscoelho/ATVV-Atlantis.git
  ```
