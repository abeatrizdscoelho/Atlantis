...
import type { ClienteFormData, TitularMock } from '../../../types/cliente';

interface ClienteFormProps {
    formData: ClienteFormData;
    mockTitulares: TitularMock[];
...
const ClienteForm: React.FC<ClienteFormProps> = ({ formData, mockTitulares, handleChange, setClienteType, isEditing }) => {
    return (
        <>
            {!isEditing && (
